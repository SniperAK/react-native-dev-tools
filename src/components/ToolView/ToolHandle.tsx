...
import {
  useTools
} from '../../context/toolManager/ToolContext';
...
const ToolHandle = ({
  ...
  return (
    ...
    >
      <View style={[
        styles.handleInner, isRight ? styles.handleInnerRight : styles.handleInnerLeft,
        { backgroundColor: pallete.mainBg },
        { backgroundColor },
      ]} {...handle.responder}>
        <View style={[styles.handleBar, { backgroundColor: pallete.line }]} />
        <View style={[styles.handleBar, { backgroundColor: pallete.line }]} />
      </View>
    </Animated.View >
  )
